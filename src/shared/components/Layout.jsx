        ...
        <nav className="sidebar-nav">
          ...
          <div className="nav-section">
            ...
            <NavLink to="/lugares" className={({isActive}) => isActive ? 'nav-item active' : 'nav-item'}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.5 1.5 0 01-2.828 0l-4.243-4.243A6 6 0 1117.657 16.657z" />
          ...
          <div className="nav-section">
            ...
            <NavLink to="/configuracion/accesibilidad" className={({isActive}) => isActive ? 'nav-item active' : 'nav-item'}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <NavLink to="/configuracion/navegacion" className={({isActive}) => isActive ? 'nav-item active' : 'nav-item'}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <NavLink to="/configuracion/privacidad" className={({isActive}) => isActive ? 'nav-item active' : 'nav-item'}>
              <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
